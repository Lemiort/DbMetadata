...
namespace DbMetadata.Controllers
{
    public class PropertiesController : Controller
    {
        ...
        public PropertiesController(MetadataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PropertyId,Title,Value")] Property @property)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PropertyId,Title,Value")] Property @property)
        {
